...
az acr build --registry $ACR_NAME --image $APP_NAME:v13-multiuser \
  --file server/Dockerfile \
  --build-arg VITE_SPA_CLIENT_ID="d38c25fa-3ce8-4648-87ab-079dcc52754b" \
  --build-arg VITE_API_CLIENT_ID="b5a8a565-e18e-42a6-a57b-ade6d17aa197" \
...
az containerapp create \
  ...
  --resource-group $RG \
  --environment $ACA_ENV \
  --image "$ACR_NAME.azurecr.io/$APP_NAME:v13-multiuser" \
  --target-port 8000 \
  --ingress external \
  --min-replicas 1 \
  ...
  --env-vars \
    ...
    MCP_AUTH_TOKENS='{"e5ba95c8bd0fef507c42ddf1a07fee4251c4404c667b6574eecd6219209105e8":"caleb.lucas@myadvisor.co.nz","4ec4afeaf2bb6de66637816da42d591fa01b670b07a5cc9469a44b82f5ca649e":"mark.lucas@myadvisor.co.nz"}' \
    API_AZURE_TENANT_ID="12e7fcaa-f776-4545-aacf-e89be7737cf3" \
    API_AZURE_CLIENT_ID="b5a8a565-e18e-42a6-a57b-ade6d17aa197"
